...
public class Medal
{
    ...
    public async Task<MedalSettings?> GetSettingsAsync(CancellationToken cancellationToken = default)
    {
        ...
        return medalSettingsDto?.ToRichModel();
    }
    ...
    public async Task<IReadOnlyDictionary<OsuGamemode, BeatmapPack>> GetBeatmapPacksAsync(CancellationToken cancellationToken = default)
    {
        ...
        return beatmapPacks!.ToDictionary(e => e.Key, e => e.Value.ToRichModel(UnitOfWork));
    }
}