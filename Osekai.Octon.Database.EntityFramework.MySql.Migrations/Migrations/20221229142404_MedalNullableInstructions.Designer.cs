...
namespace Osekai.Octon.Database.EntityFramework.MySql.Migrations
{
    ...
    [Migration("20221229142404_MedalNullableInstructions")]
    partial class MedalNullableInstructions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.App", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.BeatmapPack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.BeatmapPackForMedal", b =>
                {
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.Medal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.Session", b =>
                {
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.AppTheme", b =>
                {
                    b.HasOne("Osekai.Octon.Database.Models.App", "App")
                        .WithOne("AppTheme")
            ...
            modelBuilder.Entity("Osekai.Octon.Database.Models.BeatmapPackForMedal", b =>
                {
                    b.HasOne("Osekai.Octon.Database.Models.BeatmapPack", "BeatmapPack")
                        .WithMany("MedalsForBeatmapPack")
                        .HasForeignKey("BeatmapPackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Osekai.Octon.Database.Models.Medal", "Medal")
