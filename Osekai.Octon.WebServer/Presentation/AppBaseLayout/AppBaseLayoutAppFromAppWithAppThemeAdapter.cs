...
public class AppBaseLayoutAppFromAppWithAppThemeAdapter: IAdapter<IReadOnlyAppWithAppTheme, AppBaseLayoutApp>
{
    protected ObjectPool<StringBuilder> StringBuilderObjectPool { get; }

    protected CurrentLocale CurrentLocale { get; }
    
    public AppBaseLayoutAppFromAppWithAppThemeAdapter(CurrentLocale currentLocale,
    ...
    public async Task<AppBaseLayoutApp> AdaptAsync(IReadOnlyAppWithAppTheme e, CancellationToken cancellationToken = default)
    {
