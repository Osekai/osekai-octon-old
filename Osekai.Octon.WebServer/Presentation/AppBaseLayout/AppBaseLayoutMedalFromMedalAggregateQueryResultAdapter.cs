...
public class AppBaseLayoutMedalFromMedalAggregateQueryResultAdapter: IAdapter<IReadOnlyMedalAggregateQueryResult, AppBaseLayoutMedal>
{   
    protected ObjectPool<StringBuilder> StringBuilderObjectPool { get; }

    public AppBaseLayoutMedalFromMedalAggregateQueryResultAdapter(ObjectPool<StringBuilder> stringBuilderObjectPool)
    {
    ...
    public Task<AppBaseLayoutMedal> AdaptAsync(IReadOnlyMedalAggregateQueryResult m, CancellationToken cancellationToken)
    {
