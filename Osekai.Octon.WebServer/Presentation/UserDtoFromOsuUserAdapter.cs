...
public class UserDtoFromOsuUserAdapter: IAdapter<OsuUser, UserDto>
{
    public Task<UserDto> AdaptAsync(OsuUser osuUser, CancellationToken cancellationToken = default)
    {
        ...
        return Task.FromResult(osuUserDto);
    }
}